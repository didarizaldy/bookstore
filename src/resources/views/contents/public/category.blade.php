...
@section('content')
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-12 d-flex justify-content-between align-items-center">
          ...
          <form action="{{ route('public.category.show', ['slug' => generateSlug($category->name)]) }}" method="GET"
            class="form-inline d-none d-md-inline-flex">
      ...
      <div class="card d-none d-md-block">
        ...
        <div class="card-body p-0">
          <ul class="nav nav-pills flex-column">
            <div class="container">
              <li class="nav-item">
                <form action="{{ route('public.category.show', ['slug' => generateSlug($category->name)]) }}"
                  method="GET">
      ...
      <div class="row">
        @if ($category && $products->isNotEmpty())
          @foreach ($products as $product)
            <div class="col-6 mb-2 col-md-2 col-lg-3 col-sm-6">
            ...
            <section class="content">
              <div class="error-page">
                <div class="error-content">
                  <h3><i class="fas fa-exclamation-triangle text-warning"></i> Wah! Kategori Tidak Ditemukan.</h3>
                  <p>Kamu bisa banget rekomenin kategori itu ke kami ya untuk kami rilis di toko.</p>
                </div>
                <!-- /.error-content -->
              </div>
              <!-- /.error-page -->
            ...
            <section class="content">
              <div class="error-page">
                <div class="error-content">
                  ...
                  <p>Kamu bisa banget rekomenin produk itu ke kami ya untuk kami rilis di toko.</p>
                </div>
                <!-- /.error-content -->
              </div>
              <!-- /.error-page -->
  ...
  <!-- Pagination Links -->
  {{ $products->appends(['sort' => $sort, 'min_price' => $minPrice, 'max_price' => $maxPrice])->links() }}
