                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input name="maps" class="form-control" id="maps-{{ $address->id }}"
                            placeholder="Titik Google Maps" value="{{ $address->maps }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="city-{{ $address->id }}">Kota/Kabupaten</label>
                          <input name="city" class="form-control" id="city-{{ $address->id }}"
                            placeholder="Masukkan Kota/Kabupaten" value="{{ $address->city }}" required>
                        </div>
                      </div>
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('public.user.shipping.store') }}" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
              <label for="maps">Pin Location</label>
              <input name="maps" class="form-control" id="maps" placeholder="Titik Google Maps" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input name="city" class="form-control" id="city" placeholder="Masukkan Kota/Kabupaten"
                required>
            </div>
          </div>
          <div class="modal-footer">
